# ADR-018 — Notch as a Feature Container

- **Status:** Accepted
- **Date:** 2026-09-11
- **Decision owners:** Project maintainers
- **Related gates:** `G07`, `G08`, `G09`
...
Model the notch as a feature container with semantic routes such as Idle, Launcher, Dashboard, Notifications, PowerMenu and Tools. Keep its application state independent from its renderer.
...
- Avoid coupling launcher/dashboard logic to geometry.
...
- Presentation layer still owns transition and sizing details.
...
This ADR is validated through: `G07`, `G08`, `G09`.
