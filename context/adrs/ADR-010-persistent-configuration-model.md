# ADR-010 — Persistent Configuration Model
...
Store user configuration separately from runtime state. Use serde-backed TOML initially with validation, defaults, versioning and recoverable migration.
...
- Safe recovery from invalid values.
...
- Requires schema/version discipline.
