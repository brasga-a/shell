# ADR-033 — Future Custom Renderer Exit Path

- **Status:** Accepted
- **Date:** 2026-09-11
- **Decision owners:** Project maintainers
- **Related gates:** `G18`, `G22`
...
Do not build a custom renderer now. If GPUI fails measurable shell requirements, the preferred direction is wayland-client + SCTK + wgpu with dedicated geometry/text components. Core and service contracts must remain reusable.
...
- Prevents panic-driven rewrites.
- Avoids premature renderer engineering.
...
- **Remain on GPUI**
- **Move to custom Wayland + wgpu renderer**
...
- A custom frontend is a major undertaking and must be justified by measured constraints.
...
This ADR is validated through: `G18`, `G22`.
