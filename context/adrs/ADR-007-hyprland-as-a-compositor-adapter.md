# ADR-007 — Hyprland as a Compositor Adapter
...
Integrate Hyprland through a dedicated adapter using IPC/event sockets. Raw Hyprland data must be translated into internal compositor types before reaching the core.
...
- Hyprland-first without Hyprland-shaped domain.
- Event-driven state.
- Future compositor adapters remain possible.
...
- Hyprland-only capabilities need capability/extension handling.
...
This ADR is validated through: `G05`.
