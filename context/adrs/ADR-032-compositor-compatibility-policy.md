# ADR-032 — Compositor Compatibility Policy

- **Status:** Accepted
- **Date:** 2026-09-11
- **Decision owners:** Project maintainers
- **Related gates:** `G05`, `G18`
...
The product is Hyprland-first but must distinguish generic Wayland/compositor capabilities from Hyprland-specific extensions. Unsupported features degrade through capability detection rather than contaminating shared domain types.
...
- Preserve product velocity on Hyprland.
- Keep future compositor support feasible.
...
- Not every feature will be portable.
...
This ADR is validated through: `G05`, `G18`.
