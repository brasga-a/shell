# ADR-034 — Performance Budgets and Regression Policy
...
Establish performance budgets only after collecting release-build baselines. Track startup time, idle CPU/RAM, animation frame time, event latency and memory growth; reject regressions based on measured user impact.
...
- Requires repeatable measurement environment.
...
This ADR is validated through: `G16`.
