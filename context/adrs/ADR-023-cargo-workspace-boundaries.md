# ADR-023 — Cargo Workspace Boundaries
...
Use a small set of crates that enforce real dependency boundaries: shell-core, shell-platform, shell-hyprland, shell-linux, shell-config, shell-theme, shell-ui-gpui and shell-app. Split further only for ownership or dependency reasons.
...
- Cross-crate types require deliberate API design.
...
This ADR is validated through: `G00`.
