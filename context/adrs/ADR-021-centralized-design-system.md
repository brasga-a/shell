# ADR-021 — Centralized Design System
...
Centralize colors, typography, spacing, radii, shadows, motion and icons in shell-theme. Feature modules consume tokens rather than embedding arbitrary constants.
...
- Theme APIs become shared dependencies and must remain small.
...
This ADR is validated through: `G14`.
