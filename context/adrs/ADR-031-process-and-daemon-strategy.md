# ADR-031 — Process and Daemon Strategy

- **Status:** Accepted
- **Date:** 2026-09-11
- **Decision owners:** Project maintainers
- **Related gates:** `G15`, `G17`
...
Keep the initial shell in one Rust process. Split a subsystem into a daemon only for privilege separation, crash isolation, independent lifecycle, external IPC or security boundaries.
...
- Simpler deployment.
- Avoid gratuitous IPC.
- Rust already supports low-level integrations in-process.
...
- One process increases blast radius if boundaries are poorly implemented.
...
This ADR is validated through: `G15`, `G17`.
