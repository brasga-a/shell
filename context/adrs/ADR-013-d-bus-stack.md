...
Use zbus as the default Rust D-Bus stack for desktop integrations such as NetworkManager, BlueZ, UPower, MPRIS, StatusNotifierItem and notifications where protocol-compatible.
...
- Rust-native async API.
- Broad desktop protocol coverage.
- Reduces shell-command parsing.
...
- Complex D-Bus interfaces still require careful type modeling.
...
This ADR is validated through: `G11`, `G12`.
