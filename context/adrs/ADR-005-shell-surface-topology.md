# ADR-005 — Shell Surface Topology
...
Choose between one fullscreen transparent shell surface per output and multiple independent layer surfaces only after both are tested. Default status remains Proposed until G03 is complete.
...
- Input-region correctness.
- Focus behavior.
- Exclusive zones.
- Animation and lifecycle simplicity.

---

## Alternatives considered

- **Unified fullscreen transparent surface per output**
- **Independent layer-shell surfaces per feature**
...
- The choice materially affects Wayland behavior and cannot be guessed safely.
...
This ADR is validated through: `G03`.
