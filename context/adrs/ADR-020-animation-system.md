# ADR-020 — Animation System

- **Status:** Accepted
- **Date:** 2026-09-11
- **Decision owners:** Project maintainers
- **Related gates:** `G08`, `G16`
...
Keep semantic state separate from animation state. Use GPUI-native animation facilities where adequate and add a small shared motion layer for easing, springs and interruptible transitions only when repeated needs emerge.
...
- Smooth reusable motion without building an engine.
- Interrupted animations cannot corrupt app state.
...
- Custom motion infrastructure can grow into accidental framework work.
...
This ADR is validated through: `G08`, `G16`.
