# ADR-024 — Error Handling and Recovery
...
Use typed subsystem errors, recover from expected IO/protocol failures, and degrade only the affected feature. Avoid panic/unwrap in recoverable production paths. Reconnect long-lived adapters when practical.
...
- Shell must remain usable when optional services fail.
- Clear diagnostics.
...
- Recovery state machines add complexity.
...
This ADR is validated through: `G15`.
