# ADR-027 — Application Discovery and Launcher Execution
...
Discover applications from freedesktop .desktop entries, normalize them into internal application records, cache/index search data, and launch through a dedicated application service rather than UI subprocesses.
...
- Correct Linux launcher semantics.
- Search and execution are testable outside GPUI.
...
- Desktop-entry parsing and execution rules require careful compliance.
...
This ADR is validated through: `G09`.
