# ADR-011 — Async Runtime and Concurrency Model

- **Status:** Accepted
- **Date:** 2026-09-11
- **Decision owners:** Project maintainers
- **Related gates:** `G01`, `G05`, `G11`, `G15`
...
Use async for IO-bound adapters and services, with Tokio where appropriate. Background tasks communicate with application state through controlled messages/events and may not mutate arbitrary UI state directly.
...
- Safe concurrency.
- Good fit for sockets, D-Bus and service subscriptions.
- Keeps render loop ownership clear.
...
- Bridging GPUI and async runtimes needs explicit design.
...
This ADR is validated through: `G01`, `G05`, `G11`, `G15`.
