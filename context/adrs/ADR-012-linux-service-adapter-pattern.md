# ADR-012 — Linux Service Adapter Pattern

- **Status:** Accepted
- **Date:** 2026-09-11
- **Decision owners:** Project maintainers
- **Related gates:** `G10`, `G11`, `G15`
...
Each Linux subsystem has one authoritative adapter behind an application-facing port. Prefer event subscriptions over polling and share services across all UI consumers.
...
- Avoid duplicate clients and state.
...
- Some services will require native bindings or D-Bus complexity.
...
This ADR is validated through: `G10`, `G11`, `G15`.
