# ADR-003 — Frontend Must Remain Replaceable

- **Status:** Accepted
- **Date:** 2026-09-11
- **Decision owners:** Project maintainers
- **Related gates:** `G00`, `G22`
...
Treat every frontend implementation as a presentation adapter. GPUI types may not leak into core state, commands, services, or domain models.
...
- Preserve migration path to SCTK/wgpu or another frontend.
- Avoid framework lock-in at domain boundaries.
...
- A future renderer migration still requires rewriting visual components.
...
This ADR is validated through: `G00`, `G22`.
